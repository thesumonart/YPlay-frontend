        ...
        {step === "details" && (
          ...
          >
            ...
            <div className="lg:col-span-2 flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-border bg-surface px-3 py-2.5 text-sm text-text placeholder:text-text-secondary focus:outline-none focus:ring-2 focus:ring-primary"
                />
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-lg border border-border bg-surface px-3 py-2.5 text-sm text-text placeholder:text-text-secondary focus:outline-none focus:ring-2 focus:ring-primary"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <select
                    ...
                    className="w-full rounded-lg border border-border bg-surface px-3 py-2.5 text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary"
                  >
                    {categories.map((c) => (
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex aspect-video w-full flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed border-border bg-surface-secondary cursor-pointer hover:border-primary/50 transition-colors">
              ...
              <div className="rounded-xl border border-border bg-surface-secondary p-4 flex flex-col gap-2">
