        ...
        <AnimatePresence mode="wait">
          {activeVideo ? (
            ...
            >
              ...
              <div className="hidden xl:block rounded-2xl border border-[var(--border)] bg-[var(--surface-secondary)] aspect-video flex items-center justify-center">
                <p className="text-sm text-[var(--text-secondary)] text-center p-8">
