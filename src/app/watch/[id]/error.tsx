...
export default function WatchError({ error, reset }: ErrorProps) {
  ...
  return (
    ...
    >
      <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-[var(--danger)]/10 border border-[var(--danger)]/20">
      ...
      <div className="flex flex-col gap-2 max-w-sm">
        ...
        <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
          This video couldn&apos;t be loaded. It may have been removed or there was a temporary error.
        </p>
        {error.digest && (
          <p className="mt-1 font-mono text-xs text-[var(--text-secondary)] bg-[var(--surface-secondary)] rounded-lg px-3 py-1.5">
